...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package name.jchein.demo.zumepizza.services.${parentArtifactId}.grpc.server;
...
import name.jchein.demo.zumepizza.services.${parentArtifactId}.backend.IExampleDomainService;
import name.jchein.demo.zumepizza.services.${parentArtifactId}.domain.Example;
import name.jchein.demo.zumepizza.services.${parentArtifactId}.grpc.proto.CreateExampleRequest;
import name.jchein.demo.zumepizza.services.${parentArtifactId}.grpc.proto.ExampleGrpc;
