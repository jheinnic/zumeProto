...
public class TestHashTwo {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				String.format("%d %d %d %d %d", leastHi, leastLo, mostHi, mostLo, signs));
		...
		String obfu2 = hashids.encode(leastHi, leastLo+1, mostHi, mostLo);
