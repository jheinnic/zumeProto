package name.jchein.demo.zumepizza.services.edge.delivery.backend;


import io.eventuate.EntityWithIdAndVersion;
import io.eventuate.sync.AggregateRepository;
import name.jchein.common.validation.constraints.UUIDString;
import name.jchein.demo.zumepizza.services.edge.delivery.domain.CreateExample;
import name.jchein.demo.zumepizza.services.edge.delivery.domain.Example;
import name.jchein.demo.zumepizza.services.edge.delivery.domain.ExampleCommand;
