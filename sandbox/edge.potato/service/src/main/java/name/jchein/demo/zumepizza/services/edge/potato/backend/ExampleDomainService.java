package name.jchein.demo.zumepizza.services.edge.potato.backend;


import io.eventuate.EntityWithIdAndVersion;
import io.eventuate.sync.AggregateRepository;
import name.jchein.common.validation.constraints.UUIDString;
import name.jchein.demo.zumepizza.services.edge.potato.domain.CreateExample;
import name.jchein.demo.zumepizza.services.edge.potato.domain.Example;
import name.jchein.demo.zumepizza.services.edge.potato.domain.ExampleCommand;
