...
// compiled by ocamlc 3.11.1, ocamljs 0.2
  var ocamljs$caml_named_value = (function () {
    ...
    var caml_callback = function (f, a) {
      return _(f, [a]);
    }
    var caml_callback2 = function (f, a1, a2) {
      return _(f, [a1, a2]);
    }
    var caml_callback3 = function (f, a1, a2, a3) {
      return _(f, [a1, a2, a3]);
    }
    var caml_callback4 = function (f, a1, a2, a3, a4) {
      return _(f, [a1, a2, a3, a4]);
    }
    var caml_callback5 = function (f, a1, a2, a3, a4, a5) {
      return _(f, [a1, a2, a3, a4, a5]);
    }
    var caml_callbackN = function (f, n, args) {
      return _(f, args);
    }
// XXX caml_callback_exn ?
    ...
    var caml_equal = function (v1, v2) {
      return compare_val(v1, v2, 0) == 0;
    }
    var caml_failwith = function (s) {
      throw $(Failure$19g, s);
    }
    ...
    var caml_greaterthan = function (v1, v2) {
      return compare_val(v1, v2, 0) > 0;
    }
    var caml_greaterequal = function (v1, v2) {
      return compare_val(v1, v2, 0) >= 0;
    }
    ...
    var caml_input_value = function () {
      throw 'caml_input_value';
    }
    var caml_input_value_from_string = function () {
      throw 'caml_input_value_from_string';
    }
    var caml_install_signal_handler = function () {
      throw 'caml_install_signal_handler';
    }
    var caml_int_compare = function (i1, i2) {
      return (i1 > i2) - (i1 < i2);
    }
    var caml_int32_compare = function (i1, i2) {
      return (i1 > i2) - (i1 < i2);
    }
    var caml_int64_compare = function (i1, i2) {
    ...
    var caml_invalid_argument = function (s) {
      throw $(Invalid_argument$18g, s);
    }
    var caml_is_printable = function (c) {
      return c > 31 && c < 127;
    } // XXX get this right
    var caml_lessthan = function (v1, v2) {
      return compare_val(v1, v2, 0) - 1 < -1;
    }
    var caml_lessequal = function (v1, v2) {
      return compare_val(v1, v2, 0) - 1 <= -1;
    }
    ...
    var caml_marshal_data_size = function () {
      throw 'caml_marshal_data_size';
    }
    var caml_md5_chan = function () {
      throw 'caml_md5_chan';
    }
    var caml_md5_string = function () {
      throw 'caml_md5_string';
    }
    var caml_ml_channel_size = function () {
      throw 'caml_ml_channel_size';
    }
    var caml_ml_channel_size_64 = function () {
      throw 'caml_ml_channel_size_64';
    }
    var caml_ml_close_channel = function () {
    ...
    var caml_ml_input = function () {
      throw 'caml_ml_input';
    }
    var caml_ml_input_char = function () {
      throw 'caml_ml_input_char';
    }
    var caml_ml_input_int = function () {
      throw 'caml_ml_input_int';
    }
    var caml_ml_input_scan_line = function () {
      throw 'caml_ml_input_scan_line';
    }
    var caml_ml_open_descriptor_in = function () {
      return 0;
    } // XXX
    var caml_ml_open_descriptor_out = function () {
      return 0;
    } // XXX
    var caml_ml_out_channels_list = function () {
      return 0;
    }

    var caml_ml_output = function (c, b, s, l) {
      print_verbatim(b);
    }
    var caml_ml_output_char = function (c, ch) {
    }

    var caml_ml_output_int = function () {
      throw 'caml_ml_output_int';
    }
    var caml_ml_pos_in = function () {
      throw 'caml_ml_pos_in';
    }
    var caml_ml_pos_in_64 = function () {
      throw 'caml_ml_pos_in_64';
    }
    var caml_ml_pos_out = function () {
      throw 'caml_ml_pos_out';
    }
    var caml_ml_pos_out_64 = function () {
      throw 'caml_ml_pos_out_64';
    }
    var caml_ml_seek_in = function () {
      throw 'caml_ml_seek_in';
    }
    var caml_ml_seek_in_64 = function () {
      throw 'caml_ml_seek_in_64';
    }
    var caml_ml_seek_out = function () {
      throw 'caml_ml_seek_out';
    }
    var caml_ml_seek_out_64 = function () {
      throw 'caml_ml_seek_out_64';
    }
    var caml_ml_set_binary_mode = function () {
      throw 'caml_ml_set_binary_mode';
    }
    var caml_named_value = function (n) {
      return oc$$nv[n];
    }
    var caml_nativeint_compare = function (i1, i2) {
      return (i1 > i2) - (i1 < i2);
    }
    var caml_notequal = function (v1, v2) {
      return compare_val(v1, v2, 0) != 0;
    }
    ...
    var caml_obj_is_block = function (o) {
      return !(typeof o == 'number')
    }
    var caml_obj_tag = function (o) {
      return o.t;
    }
    var caml_obj_set_tag = function (o, t) {
      o.t = t;
    }
    var caml_obj_block = function (t, s) {
      if (s == 0) return t; else {
        var a = new Array(s);
        a.t = t;
        return a;
      }
    }
    var caml_obj_truncate = function (o, s) {
      o.length = s;
    }
    var caml_output_value = function () {
      throw 'caml_output_value';
    }
    var caml_output_value_to_string = function () {
      throw 'caml_output_value_to_string';
    }
    var caml_output_value_to_buffer = function () {
      throw 'caml_output_value_to_buffer';
    }
    var caml_record_backtrace = function () {
      throw 'caml_record_backtrace';
    }
    var caml_backtrace_status = function () {
      throw 'caml_backtrace_status';
    }
    var caml_get_exception_backtrace = function () {
      throw 'caml_get_exception_backtrace';
    }
    var caml_register_named_value = function (n, v) {
      oc$$nv[n] = v;
    }
    ...
    var caml_sys_exit = function () {
      throw 'caml_sys_exit';
    }
    var init_time = (new Date()).getTime() / 1000;
    var caml_sys_time = function () {
      return (new Date()).getTime() / 1000 - init_time;
    }
    var caml_sys_get_argv = function () {
      return $('', $());
    } // XXX put something here?
    var caml_sys_get_config = function () {
      return $('js', 32);
    } // XXX browser name?
    var caml_sys_open = function () {
      throw 'caml_sys_open';
    }
    var caml_sys_random_seed = function () {
          ...
          switch (ml - al) {
            case 1:
              return _f(function (z) {
                return m.apply(t, ap(a, arguments))
              });
            case 2:
...
@end @*/
    var oc$Pervasives$ =
      function () {
        var failwith$54 = _f(function (s$55) {
          throw $(Failure$19g, s$55);
        });
        var invalid_arg$56 = _f(function (s$57) {
          throw $(Invalid_argument$18g, s$57);
        });
        var Exit$58 = $('Pervasives.Exit');
        var min$66 = _f(function (x$67, y$68) {
          if (caml_lessequal(x$67, y$68)) return x$67;
          return y$68;
        });
        var max$69 = _f(function (x$70, y$71) {
          if (caml_greaterequal(x$70, y$71)) return x$70;
          return y$71;
        });
        var abs$87 = _f(function (x$88) {
          if (x$88 >= 0) return x$88;
          return -x$88;
        });
        var lnot$92 = _f(function (x$93) {
          return x$93 ^ -1;
        });
        ...
        var $5E$152 = _f(function (s1$153, s2$154) {
          return s1$153.toString() + s2$154.toString();
        });
        var char_of_int$157 =
          _f(function (n$158) {
            if (n$158 < 0 || n$158 > 255) return __(invalid_arg$56, ['char_of_int']);
            return n$158;
          });
        var string_of_bool$164 = _f(function (b$165) {
          if (b$165) return 'true';
          return 'false';
        });
        ...
        var string_of_int$167 = _f(function (n$168) {
        ...
        var string_of_float$177 = _f(function (f$178) {
          return __(valid_float_lexem$172, [oc$$sprintf('%.12g', f$178)]);
        });
        var $40$180 =
          _f(function (l1$181, l2$182) {
            if (l1$181) return $(l1$181[0], _($40$180, [l1$181[1], l2$182]));
            return l2$182;
          });
        ...
        var open_out$216 = _f(function (name$217) {
          return __(open_out_gen$212, [$(1, $(3, $(4, $(7, 0)))), 438, name$217]);
        });
        var open_out_bin$218 = _f(function (name$219) {
        ...
        var output_string$228 = _f(function (oc$229, s$230) {
        ...
        var output_value$239 = _f(function (chan$240, v$241) {
          return caml_output_value(chan$240, v$241, 0);
        });
        var close_out$246 = _f(function (oc$247) {
        ...
        var open_in$255 = _f(function (name$256) {
          return __(open_in_gen$251, [$(0, $(7, 0)), 0, name$256]);
        });
        var open_in_bin$257 = _f(function (name$258) {
        ...
        var close_in_noerr$300 = _f(function (ic$301) {
          try {
        ...
        var print_newline$313 = _f(function (param$419) {
          caml_ml_output_char(stdout$190, 10);
          return caml_ml_flush(stdout$190);
        });
        var prerr_char$314 = _f(function (c$315) {
          return caml_ml_output_char(stderr$191, c$315);
        });
        var prerr_string$316 = _f(function (s$317) {
          return __(output_string$228, [stderr$191, s$317]);
        });
        var prerr_int$318 = _f(function (i$319) {
          return __(output_string$228, [stderr$191, _(string_of_int$167, [i$319])]);
        });
        var prerr_float$320 = _f(function (f$321) {
        ...
        var prerr_newline$324 = _f(function (param$418) {
          caml_ml_output_char(stderr$191, 10);
          return caml_ml_flush(stderr$191);
        });
        var read_line$325 = _f(function (param$417) {
          caml_ml_flush(stdout$190);
          return __(input_line$278, [stdin$189]);
        });
        var read_int$326 = _f(function (param$416) {
          return caml_int_of_string(_(read_line$325, [0]));
        });
        var read_float$327 = _f(function (param$415) {
          return caml_float_of_string(_(read_line$325, [0]));
        });
        var LargeFile$334 = $();
        var $5E$5E$349 = _f(function (fmt1$350, fmt2$351) {
        ...
        var do_at_exit$362 = _f(function (param$413) {
          return __(exit_function$358[0], [0]);
        });
        var exit$363 = _f(function (retcode$364) {
          _(do_at_exit$362, [0]);
    ...
    var oc$Char$ =
      function () {
        var chr$60 = _f(function (n$61) {
          if (n$61 < 0 || n$61 > 255) return __(oc$Pervasives$[0], ['Char.chr']);
          return n$61;
        });
        var escaped$66 =
          _f(function (c$67) {
        ...
        var compare$76 = _f(function (c1$77, c2$78) {
          return c1$77 - c2$78;
        });
      ...
      function () {
        var length_aux$58 =
          _f(function (len$59, param$394) {
            if (param$394) return __(length_aux$58, [len$59 + 1, param$394[1]]);
            return len$59;
          });
        var length$62 = _f(function (l$63) {
          return __(length_aux$58, [0, l$63]);
        });
        var hd$64 = _f(function (param$393) {
          if (param$393) return param$393[0];
          return __(oc$Pervasives$[1], ['hd']);
        });
        var tl$67 = _f(function (param$392) {
          if (param$392) return param$392[1];
        ...
        var rev_append$79 =
          _f(function (l1$80, l2$81) {
            if (l1$80) return __(rev_append$79, [l1$80[1], $(l1$80[0], l2$81)]);
            return l2$81;
          });
        var rev$84 = _f(function (l$85) {
    ...
    var oc$String$ =
      function () {
        var make$66 = _f(function (n$67, c$68) {
          var s$69 = oc$$cms(n$67);
        ...
        var iter$90 =
          _f(function (f$91, a$92) {
            for (var i$93 = 0; i$93 <= a$92.length - 1; i$93++) {
              (function (i$93) {
                    ...
                    r$26: {
                      {
                        ...
                        if ($r27) {
                          {
                            if (caml_is_printable(c$112)) return 1;
                            return 4;
                          }
                        }
                      }
        ...
        var uppercase$124 = _f(function (s$125) {
          return __(map$118, [oc$Char$[3], s$125]);
        });
        var lowercase$126 = _f(function (s$127) {
        ...
        var capitalize$132 = _f(function (s$133) {
          return __(apply1$128, [oc$Char$[3], s$133]);
        });
        var uncapitalize$134 = _f(function (s$135) {
        ...
        var index$141 = _f(function (s$142, c$143) {
        ...
        var rindex$153 = _f(function (s$154, c$155) {
        ...
        var contains$165 = _f(function (s$166, c$167) {
        ...
        var compare$173 = _f(function (prim$175, prim$174) {
      ...
      function () {
        var init$65 =
          _f(function (l$66, f$67) {
            ...
            for (var i$69 = 1; i$69 <= -1 + l$66; i$69++) {
              (function (i$69) {
        ...
        var copy$77 =
          _f(function (a$78) {
            ...
            for (var i$81 = 1; i$81 <= -1 + l$79; i$81++) {
              (function (i$81) {
        ...
        var append$82 =
          _f(function (a1$83, a2$84) {
            ...
            for (var i$88 = 0; i$88 <= l1$85 - 1; i$88++) {
              (function (i$88) {
                r$87[i$88] = a1$83[i$88];
              }(i$88));
            }
            for (var i$89 = 0; i$89 <= l2$86 - 1; i$89++) {
              (function (i$89) {
        ...
        var iter$128 =
          _f(function (f$129, a$130) {
            for (var i$131 = 0; i$131 <= a$130.length - 1; i$131++) {
              (function (i$131) {
                _(f$129, [a$130[i$131]]);
              }(i$131));
            }
    ...
    var oc$Sys$ =
      function () {
        ...
        var set_signal$85 = _f(function (sig_num$86, sig_beh$87) {
        ...
        var catch_break$110 =
          _f(function (on$111) {
            if (on$111) return __(set_signal$85, [sigint$93, $(_f(function (param$116) {
              throw $(Break$109);
            }))]);
    ...
    var oc$Int32$ =
      function () {
        ...
        var one$77 = 1;
        var minus_one$78 = -1;
        var succ$79 = _f(function (n$80) {
          return n$80 + 1;
        });
        var pred$81 = _f(function (n$82) {
          return n$82 - 1;
        });
        var abs$83 = _f(function (n$84) {
          if (n$84 >= 0) return n$84;
          return -n$84;
        });
        var min_int$85 = -2147483648;
        var max_int$86 = 2147483647;
        var lognot$87 = _f(function (n$88) {
          return n$88 ^ -1;
        });
        var to_string$90 = _f(function (n$91) {
          return caml_format_int('%d', n$91);
        });
        var compare$94 = _f(function (x$95, y$96) {
    ...
    var oc$Int64$ =
      function () {
        ...
        var one$79 = '1';
        var minus_one$80 = '-1';
        var succ$81 = _f(function (n$82) {
          return n$82 + '1';
        });
        var pred$83 = _f(function (n$84) {
          return n$84 - '1';
        });
        var abs$85 = _f(function (n$86) {
          if (n$86 >= '0') return n$86;
          return -n$86;
        });
        var min_int$87 = '-9223372036854775808';
        var max_int$88 = '9223372036854775807';
        var lognot$89 = _f(function (n$90) {
          return n$90 ^ '-1';
        });
        var to_string$92 = _f(function (n$93) {
          return caml_format_int('%d', n$93);
        });
        var compare$98 = _f(function (x$99, y$100) {
    ...
    var oc$Nativeint$ =
      function () {
        ...
        var lognot$88 = _f(function (n$89) {
          return n$89 ^ -1;
        });
        var to_string$91 = _f(function (n$92) {
          return caml_format_int('%d', n$92);
        });
        var compare$95 = _f(function (x$96, y$97) {
    ...
    var oc$Ocamljs$ =
      function () {
        var option_of_nullable$74 = _f(function (x$75) {
          if (x$75 === null) return 0;
          return $(x$75);
        });
        var nullable_of_option$76 = _f(function (x$77) {
          if (x$77) return x$77[0];
          return null;
        });
        var is_null$79 = _f(function (a$80) {
          return caml_equal(a$80, null);
        });
        var Inline$268 = function () {
          var Jslib_ast$262 = $();
          var _loc$267 = 0;
    ...
    var oc$Types$ =
      function () {
        var value$96 = _f(function (param$132) {
    ...
    var oc$Myrandom$ =
      function () {
        var State$139 =
          function () {
            var new_state$63 = _f(function (param$197) {
            ...
            var copy$88 =
              _f(function (s$89) {
                var result$90 = _(new_state$63, [0]);
            ...
            var float$134 = _f(function (s$135, bound$136) {
              return _(rawfloat$128, [s$135]) * bound$136;
            });
            var bool$137 = _f(function (s$138) {
    ...
    var oc$Util$ =
      function () {
        ...
        var prob$102 = _f(function (param$418) {
          return __(oc$Myrandom$[7], [1.0]);
        });
        var rnd_int$103 = _f(function (a$104, b$105) {
          return a$104 + _(oc$Myrandom$[3], [b$105 - a$104 + 1]);
        });
        var rnd_float$106 = _f(function (u$107, v$108) {
          return u$107 + _(oc$Myrandom$[7], [v$108 - u$107]);
        });
        var rnd_name$109 =
          _f(function (n1$110, n2$111) {
            var pick$112 = _f(function (a$113) {
        ...
        var count$211 =
          _f(function (lst$212, tok$213) {
            var c$214 = _(oc$List$[10], [_f(function (t$215) {
              return $(t$215, $(0));
            }), tok$213]);
            _(oc$List$[9], [_f(function (x$216) {
              return _(oc$List$[29], [x$216, c$214])[0]++;
            }), lst$212]);
            return __(oc$List$[10], [_f(function (param$403) {
              return $(param$403[0], param$403[1][0]);
            }), c$214]);
          });
        var color_of_rgb$219 = _f(function (r$220, g$221, b$222) {
        ...
        var get$321 = _f(function (x$322, lst$323) {
    ...
    var oc$Op$ =
      function () {
                ...
                _f(function (param$675) {
                  ...
                  var fs$380 =
                    function () {
                      ...
                      return _(oc$List$[36],
                        [xs$381, _(oc$List$[10], [_f(function (r$383) {
        ...
        var ops_sort$493 =
          _f(function (s$494) {
            return __(oc$List$[26], [_f(function (f$495) {
              return caml_equal(f$495[2], s$494);
            }), ops$492]);
          });
        var string_of_op$496 = _f(function (f$497) {
          return f$497[0];
        });
        var op_of_string$498 = _f(function (n$499) {
          return __(oc$List$[25], [n$499, ops$492]);
        });
        var args$500 = _f(function (f$501) {
          return f$501[1];
        });
        var result$502 = _f(function (f$503) {
          return f$503[2];
        });
        var name$504 = _f(function (f$505) {
          return f$505[0];
        });
        var func$506 = _f(function (f$507) {
          return f$507[3];
        });
        var reduce$508 =
          _f(function (fs$509) {
    ...
    var oc$Gene$ =
      function () {
        var op$82 = _f(function (l$83) {
          return l$83[0];
        });
        var connectors$84 = _f(function (l$85) {
          return l$85[1];
        });
        var link_x$86 = _f(function (x$87) {
          return $(_(oc$Op$[0], ['x', x$87]), 0);
        });
        var link_y$88 = _f(function (y$89) {
          return $(_(oc$Op$[0], ['y', y$89]), 0);
        });
        var link_t$90 = _f(function (t$91) {
          return $(_(oc$Op$[0], ['t', t$91]), 0);
        });
        var link_pt$92 = _f(function (x$93, y$94) {
          return $(_(oc$Op$[1], [x$93, y$94]), 0);
        });
        var get_sort$95 =
          _f(function (s$96, lst$97) {
            return __(oc$List$[26], [_f(function (l$98) {
        ...
        var random_scalars$108 =
          _f(function (n$109) {
            return __(oc$Util$[11], [_f(function (param$225) {
              return __(oc$Util$[6], [-1.0, 1.0]);
            }), 1, n$109]);
          });
        var random_palette$110 =
          _f(function (n$111) {
            var p$112 = _(oc$Util$[11], [_f(function (param$224) {
            ...
            var make$132 =
              _f(function (j$133, lst$134, lst1$135) {
                if (j$133 <= 1) {
                  {
                    var ops1$136 =
                      _(oc$List$[26], [_f(function (f$137) {
        ...
        var optimize$172 =
          _f(function (g$173) {
            ...
            return __(oc$List$[26], [_f(function (l$182) {
    ...
    var oc$Genjs$ =
      (ocaml_register('new_picture',
        _(_f(function (prim$72, prim$71) {
          return caml_callback(prim$72, prim$71);
        }), [oc$Compute$[4]])), (
