...
const config_namespace_1 = require("./config.namespace");
...
class ContainerBootstrap {
    ...
    processBootScripts() {
        ...
        let bootScripts = _.uniq(this.findScripts(path.join(this.appRootDir, "boot")));
        ...
        async_1.async.eachSeries(functions, (f, done) => {
