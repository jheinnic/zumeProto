...
import {IEnvironment} from "../../app/IEnvironment";
import {MixinConstructor} from "@bstock/ts-utils/dist";
...
export class Environment implements IEnvironment {
    ...
    getConfigBranchAs<T>(jsonPath: string, type: MixinConstructor<T>): Promise<T|T[]> {
