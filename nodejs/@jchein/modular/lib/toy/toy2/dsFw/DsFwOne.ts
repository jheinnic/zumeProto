///<reference path="../../../di/module/IModuleProvider.ts"/>
/**
 * Created by jheinnic on 4/30/17.
 */
import {ContainerModule} from 'inversify';
import {TypeToken, TagToken, FactoryToken, IModuleProvider, SymbolBundle, TokenBundle, BModule, IInversifyFactory } from '../../../../lib';
