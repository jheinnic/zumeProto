...
public class GrpcFixtureData
{
	...
	public static final String VALID_TIMECARD_ID_ONE_STRING = "3ddeb300-3871-11e8-aec1-e4ce8f47a632"; 
	public static final UUID VALID_TIMECARD_ID_ONE_UUID = UUID.fromString(VALID_TIMECARD_ID_ONE_STRING);

	public static final String VALID_TIMECARD_ID_TWO_STRING = "3ffeb301-3871-11e8-aec1-e4ce8f47a632"; 
	public static final UUID VALID_TIMECARD_ID_TWO_UUID = UUID.fromString(VALID_TIMECARD_ID_TWO_STRING);
