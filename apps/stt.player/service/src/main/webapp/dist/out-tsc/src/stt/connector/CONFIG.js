...
var CONFIG = /** @class */ (function () {
    ...
    CONFIG.URL_PLATFORM = "https://thorium.disruptorbeam.com/";
    CONFIG.URL_SERVER = "https://stt.disruptorbeam.com/";
    // default client_id of the Steam Windows version of STT
    CONFIG.CLIENT_ID = "4fc852d7-d602-476a-a292-d243022a475d";
    CONFIG.CLIENT_API_VERSION = 8;
    CONFIG.CLIENT_VERSION = "3.1.0";
    CONFIG.CLIENT_PLATFORM = "webgl";
    // feedback form endpoint URL
    CONFIG.URL_USERFEEDBACK = "https://prod-23.westus.logic.azure.com:443/workflows/fb9aad14945947ee96196506c5cb99c4/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=7DdF1Ybdsk60b2Q2m063oQcxDEvzKXoT3y741A6CL1s";
    // releases URL
    CONFIG.URL_GITHUBRELEASES = "https://api.github.com/repos/IAmPicard/StarTrekTimelinesSpreadsheet/releases";
    // Every 10 days, check the wiki again for updated / new images
    CONFIG.HOURS_TO_RECOVERY = 24 * 10;
    CONFIG.RARITIES = [
    ...
    CONFIG.SPRITES = {
        ...
        'cadet_icon': { asset: 'atlas_stt_icons', url: undefined },
