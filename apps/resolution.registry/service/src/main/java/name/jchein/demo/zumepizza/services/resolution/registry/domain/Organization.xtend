...
//import name.jchein.demo.zumepizza.services.resolution.registry.command.AcceptPaintPolicy
//import name.jchein.demo.zumepizza.services.resolution.registry.command.DeprecatePaintPolicy
//import name.jchein.demo.zumepizza.services.resolution.registry.command.PaintPolicyCommand
//import name.jchein.demo.zumepizza.services.resolution.registry.command.RejectPaintPolicy
//import name.jchein.demo.zumepizza.services.resolution.registry.command.RenamePaintPolicy
//import name.jchein.demo.zumepizza.services.resolution.registry.command.RequestPaintPolicy
//import name.jchein.demo.zumepizza.services.resolution.registry.event.PaintPolicyAccepted
//import name.jchein.demo.zumepizza.services.resolution.registry.event.PaintPolicyDeprecated
//import name.jchein.demo.zumepizza.services.resolution.registry.event.PaintPolicyRejected
//import name.jchein.demo.zumepizza.services.resolution.registry.event.PaintPolicyRenamed
//import name.jchein.demo.zumepizza.services.resolution.registry.event.PaintPolicyRequested
...
//class Organization extends ReflectiveMutableCommandProcessingAggregate<PaintPolicy, PaintPolicyCommand> {
