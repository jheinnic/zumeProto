...
public class RoadLocation<Distance extends Quantity<Distance>> extends Location<Distance> {

    // Prefer Map over array or List because customers might be added and removed in real-time planning.
    protected Map<RoadLocation<Distance>, Distance> travelCostMap;
    ...
    public Map<RoadLocation<Distance>, Distance> getTravelCostMap() {
        return travelCostMap;
    }

    public void setTravelCostMap(Map<RoadLocation<Distance>, Distance> travelCostMap) {
        this.travelCostMap = travelCostMap;
    }

    @Override
    public Distance getTravelCostTo(Location<Distance> location) {
   	 return travelCostMap.get((RoadLocation<Distance>) location);
    }
}
